def process_rds_data(msgs):
	...
	if msgs.d:
		...
		if group_parsed == "00000":
			...
			char1 = Program_Type_Codes[char1_coded]
			char2 = Program_Type_Codes[char2_coded]
